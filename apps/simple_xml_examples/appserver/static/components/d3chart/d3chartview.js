// config dependencies and exports variable
require.config({
    paths: {
        "d3chart": "../app/simple_xml_examples/components/d3chart"
    },
    shim: {
        "d3chart/d3/d3.v2": {
            deps: [],
        ...
        "d3chart/d3/fisheye": {
            deps: ["d3chart/d3/d3.v2"],
            exports: "d3.fisheye"
        },
        "d3chart/d3/nv.d3": {
            deps: ["d3chart/d3/d3.v2", "d3chart/d3/fisheye"],
            exports: "nv"
        }
    }
});
...
define(function(require, exports, module) {
    ...
    var d3 = require("d3chart/d3/d3.v2");
    var Messages = require("splunkjs/mvc/messages");
    var nv = require("d3chart/d3/nv.d3");

    require("css!d3chart/d3chart.css");
    require("css!d3chart/d3/nv.d3.css");
